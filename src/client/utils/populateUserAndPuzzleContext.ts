 ...
 *
 * Given successful user data found either via loading session data or a user successfully logging
 * in, this function updates the global context with this user data and updates the page information
 * so the component navigates to the next destination via the useEffect in the Login component.
 *
 ...
 * @param newPuzzleCollection - PuzzleCollection object - puzzle data to be assigned to global
 * context
 * @param setPuzzleCollection - Dispatch function used to assign state of puzzleCollection stored in
 * global context
 */
