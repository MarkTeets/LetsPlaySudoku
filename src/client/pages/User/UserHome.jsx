/*
 I don't need this page yet. Maybe when there are more features built out including tutorials I'll need it, 
 but for now I can just send people directly from the login page to the puzzle select menu
*/
