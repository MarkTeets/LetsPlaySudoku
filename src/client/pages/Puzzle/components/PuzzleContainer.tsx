...
/** generateBoxes
 *
 * Each set in unitBoxes is a set of the squareIds that go in each of the 9 larger squares of the
 ...
 *
 * generateBoxes sequentially passes each unitBoxes Set to one of 9 BoxUnitContainer components,
 ...
 * unitBoxes and squareIds results in a grid of 81 squares with correctly positioned squareIds.
 *
